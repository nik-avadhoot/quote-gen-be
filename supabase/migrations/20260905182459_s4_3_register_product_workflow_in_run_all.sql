-- S4-3: register the product-definition workflow suite in the regression entry
-- point, and remove the scratch probe used to run it standalone during
-- development. After this, tests.run_all() is again the single command that
-- states the whole accepted position.
...
drop function if exists tests.__probe_pw();
